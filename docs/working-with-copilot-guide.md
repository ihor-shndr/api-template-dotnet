...
We highly recommend reading the [**tessl.io AI Best Practices**](./docs/tessl-io-ai-best-practices.pdf)—it captures the essential mindset for working effectively with AI. Consider it required reading, but not a rigid rulebook. Adapt its principles to fit how your team actually delivers software.
